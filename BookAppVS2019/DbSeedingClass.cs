...
namespace BookAppVS2019
{
    ...
    {
        public static void SeedDataContext(this BookDbContext context) //Utilizamos this, por que es un metodo de extencion o extencion method
        {
            var booksAuthors = new List<BookAuthor>()
            {
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        {
                            new Review { Headline = "Awesome Book", ReviewText = "Reviewing Call of the wild and it is awesome, beyond word", Rating = 5,
                            Reviewer = new Reviewer(){ FirstName = "John", LastName = "Smith" } },
                            new Review { Headline = "Terrible Book", ReviewText = "Reviewing Call of the Wild and it is terribile book", Rating = 1,
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        DatePublished = new DateTime(2019,2,3),
                        BookCategories = new List<BookCategory>()
                        {
                            new BookCategory { Category = new Category() { Name = "Action" } },
                ...
                new BookAuthor()
                {
                    Book = new Book()
                    {
                        ...
                        Reviews = new List<Review>()
                        {
                            ...
                            new Review { Headline = "Horrible Romantic Book", ReviewText = "My wife made me read ir n I hated it", Rating = 1,
            ...
            context.BookAuthors.AddRangeAsync(booksAuthors);
            context.SaveChanges();
